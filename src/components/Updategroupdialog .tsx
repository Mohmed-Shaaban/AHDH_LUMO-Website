...
} from "@/schema/group/groupSchema";
import { useUpdateGroup } from "@/features/groups/useGroup";
...
export function UpdateGroupDialog({ open, onOpenChange, group }: Props) {
 ...
 const form = useForm<UpdateGroupFormValues>({
  ...
  // Sync form when group prop changes (e.g. after re-open)
  useEffect(() => {
    if (open) {
      form.reset({
        name: group.name,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[520px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Make changes to your group settings below.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col items-center gap-3 py-2">
          ...
          >
            {nameValue ? nameValue[0].toUpperCase() : "G"}
          </div>
